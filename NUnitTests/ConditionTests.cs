...
namespace NUnit.AdapterLabTests
{
     ...
     public class ConditionTests
     {
          ...
          {
               c.Begin();
               _ = c.Add(Condition.Level.WARNING, "text", "code", "HIGH", "1123");
               c.Prepare();
          ...
          {
               c.Begin();
               _ = c.Add(Condition.Level.WARNING, "text", "code");
               c.Prepare();
               c.Cleanup();
          ...
          public void should_remove_old_activations_and_add_new()
          {
               ...
               c.Begin();
               _ = c.Add(Condition.Level.WARNING, "text", "code2");
               c.Prepare();
               List<DataItem> list = c.ItemList();
               c.Cleanup();
          ...
          {
               c.Begin();
               _ = c.Add(Condition.Level.WARNING, "text", "code1");
               _ = c.Add(Condition.Level.FAULT, "text", "code2");
               c.Prepare();
               List<DataItem> list = c.ItemList();
               c.Cleanup();
          ...
          {
               s.Begin();
               _ = s.Add(Condition.Level.WARNING, "text", "code");
               s.Prepare();
               s.Cleanup();
          ...
          {
               s.Begin();
               _ = s.Add(Condition.Level.WARNING, "text1", "code1");
               _ = s.Add(Condition.Level.FAULT, "text2", "code2");
               s.Prepare();
               List<DataItem> list = s.ItemList();
               s.Cleanup();
