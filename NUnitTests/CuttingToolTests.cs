...
namespace NUnit.AdapterLabTests
{
     ...
     {
          readonly UTF8Encoding encoder = new UTF8Encoding();
          ...
          public void should_add_a_generic_property()
          {
               ...
               _ = tool.AddProperty("ProcessSpindleSpeed",
          ...
          public void should_add_a_status()
          {
               ...
               _ = tool.AddStatus(new string[] { "USED", "MEASURED" });
          ...
          public void should_add_a_measurement()
          {
               ...
               _ = tool.AddMeasurement("BodyDiameterMax", "BDX", 120.65, 120.60, 120.25, 120.70);
          ...
          public void should_add_tool_life()
          {
               ...
               _ = tool.AddLife(CuttingTool.LifeType.MINUTES, CuttingTool.Direction.UP, "100", "0", "200", "175");
          ...
          public void should_add_cutting_item()
          {
               ...
               {
                    Description = "An insert"
               };
               _ = item.AddProperty("Locus", "22");
               _ = item.AddLife(CuttingTool.LifeType.MINUTES, CuttingTool.Direction.UP, "100", "0", "150");
               _ = item.AddMeasurement("FunctionalLength", "LF", 100);
               tool.AddItem(item);
