               ...
               public Property(string name, string[] arguments, string value = "")
               {
                    ...
                    if (arguments != null)
                    {
                         ...
                         for (int i = 0; i < arguments.Length; i += 2)
                              _ = mAttributes.Add(new Attribute(arguments[i], arguments[i + 1]));
                    }
                    Value = value;
               }
